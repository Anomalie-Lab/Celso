...
import { LuSearch, LuHeart, LuMenu, LuX } from "react-icons/lu";
                            ...
                            <div className="hidden md:flex items-center gap-2 p-2 rounded-full transition-colors  group">
                                ...
                                <div className="text-xs">
                                    ...
                                    <div className="text-gray-500">
                                        <button onClick={() => {toggleDialog(); toggleAuthPage("Login")}} className="cursor-pointer hover:text-primary transition-colors">Entrar</button><span className="ml-1 mr-1">/</span>   
                                        <button onClick={() => {toggleDialog(); toggleAuthPage("Register")}} className="cursor-pointer hover:text-primary transition-colors">  Cadastrar</button>
                                    </div>
                                </div>
                            </div>
                            <button 
                                ...
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-gray-500">
                                            <button onClick={() => router.push('/login')} className="hover:text-primary transition-colors">Entrar</button> / 
                                            <button onClick={() => router.push('/register')} className="hover:text-primary transition-colors"> Cadastrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
