interface OldPasswordResetData {
  link: string;
}
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="text-align: center; margin-bottom: 30px;">
                                        <h2 style="color: #1E2939; font-size: 24px; margin: 0 0 16px 0; font-weight: 600;">Redefinição de Senha</h2>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                                <tr>
                                    <td style="text-align: center;">
                                        <a href="${link}" style="display: inline-block; background-color: #03624C; color: white; text-decoration: none; padding: 16px 32px; font-weight: 600; font-size: 14px; text-transform: uppercase; letter-spacing: 0.5px;">
                                            Redefinir Senha
                                        </a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        <p style="color: #64748B; font-size: 13px; margin: 0; line-height: 1.5;">
                                            ...
                                            <a href="${link}" style="color: #03624C; text-decoration: underline; word-break: break-all;">${link}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
