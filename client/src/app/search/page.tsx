...
function SearchContent() {
  ...
  return (
    <main className="flex flex-col w-full min-h-screen bg-white mt-36">
       ...
       <section className="flex-1 py-8 px-4 lg:px-24">
               ...
               <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-8">
                 <div className="flex items-center justify-between mb-6">
                   ...
                   <button onClick={() => setShowFilter(!showFilter)} className="lg:hidden p-2 hover:bg-gray-100 rounded-full transition-colors cursor-pointer">
                     <IoFilterOutline className="w-5 h-5 text-gray-600" />
                   </button>
                 </div>
                 ...
                 <div className="space-y-6">
                   ...
                   <AccordionSearch nameFilter="PREÇO">
                 ...
                 <div className="flex items-center gap-4">
                   ...
                   <div className="flex items-center gap-2">
                     <button
                       ...
                       className={`p-2 rounded-lg transition-colors cursor-pointer ${viewMode === "grid" ? "bg-primary text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
                     >
                       <IoGridOutline className="w-5 h-5" />
                     </button>
                     <button
                       onClick={() => setViewMode("list")}
                       className={`p-2 rounded-lg transition-colors cursor-pointer ${viewMode === "list" ? "bg-primary text-white" : "bg-gray-100 text-gray-600 hover:bg-gray-200"}`}
                     >
