...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-50 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          <div className="space-y-4 sm:space-y-6">
            <button onClick={() => navigate.push("/")} className="cursor-pointer flex items-center justify-center w-full md:justify-start relative md:right-10">
              <Image src="/images/logo.png" width={150} height={150} alt="logo" className="w-36 h-auto" />
            </button>

            <p className="text-gray-600 text-sm text-center md:text-left leading-relaxed">Líder em equipamentos hospitalares de alta qualidade. Comprometida com a excelência e inovação na área da saúde, oferecendo produtos que fazem a diferença.</p>
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="block lg:hidden px-6 text-sm">
              <AccordionSearch nameFilter="Minha Conta">
                <ul className="space-y-2">
                  <li>
                    <button onClick={() => navigate.push("/minha-conta/pedidos")} className="text-gray-600 hover:text-primary transition-colors text-sm cursor-pointer block py-1">
                      Meus Dados
                    </button>
                  </li>
                  <li>
                    <button onClick={toggleCart} className="text-gray-600 hover:text-primary transition-colors text-sm cursor-pointer block py-1">
                      Meus Pedidos
                    </button>
                  </li>
                  <li>
                  ...
                  <li>
                    <button onClick={toggleWishList} className="text-gray-600 hover:text-primary transition-colors text-sm cursor-pointer block py-1">
                      Favoritos
                    </button>
                  </li>
                </ul>
          ...
          <div className="space-y-6 lg:space-y-8">
            ...
            <div className="hidden lg:block">
              ...
              <p className="text-gray-600 text-sm mb-4">Receba ofertas exclusivas e novidades em primeira mão.</p>
              <div className="flex flex-col sm:flex-row gap-2">
                <input type="email" placeholder="Seu email" className="flex-1 px-3 py-2 border border-gray-200 rounded-md sm:rounded-l-md sm:rounded-r-none focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary text-sm bg-white" />
              ...
              <p className="text-gray-500 text-xs mt-3">
                ...
                <button onClick={() => navigate.push("/politica-privacidade")} className="text-primary hover:underline cursor-pointer">
                  {" "}
                  Política de Privacidade
                </button>
                .
        ...
        <div className="py-6 sm:py-8 px-4 sm:px-6 lg:px-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 sm:gap-6">
            <div className="text-center lg:text-left order-3 lg:order-1 hidden md:block">
              <p className="text-gray-500 text-xs sm:text-sm">© 2024 Hospitalar Distribuidora. CNPJ: 03.375.328/0001-80</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 order-1 lg:order-2">
              ...
              <div className="flex items-center gap-2 sm:gap-4">
                <Image src="/images/visa.png" width={40} height={25} alt="Visa" className="w-8 h-5 sm:w-10 sm:h-6 object-contain" />
                <Image src="/images/mastercard.png" width={40} height={25} alt="Mastercard" className="w-8 h-5 sm:w-10 sm:h-6 object-contain" />
                <Image src="/images/pix.png" width={40} height={40} alt="Pix" className="w-8 h-8 sm:w-10 sm:h-10 object-contain" />
              </div>
            </div>
      ...
      <ModalAuth isOpen={isAuthOpen} toggleDialog={toggleAuth} authPage={authPage} onAuthPageChange={toggleAuthPage} />
    </footer>
  );
}
